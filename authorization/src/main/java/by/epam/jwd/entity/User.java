...
public class User implements Serializable {
	...
	public User(int id, String name, String surname, int discount, String email, String login, String password,
			Role role) {
		this.id = id;
		this.name = name;
	...
	public boolean equals(Object obj) {
		...
		return (id == other.getId()) && ((name != null && name.equals(other.getName())))
				...
				&& ((email != null && email.equals(other.getEmail()))) && (discount == other.getDiscount())
				&& (role == other.getRole() || (role != null && role.equals(other.getRole())));
	}

	@Override
	public String toString() {
		return getClass().getSimpleName() + " [id=" + id + ", name=" + name + ", surname=" + surname + ", login="
				+ login + ", password=" + password + ", email=" + email + ", discount=" + discount + ", role=" + role
				+ "]";
	}
